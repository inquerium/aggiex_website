...
export default function Hero() {
  return (
    <section id="hero" className="mobile-hero relative w-full py-16 md:py-24 bg-white overflow-hidden">
      ...
      <div className="mobile-hero-content container mx-auto px-6 md:px-8 grid grid-cols-1 lg:grid-cols-2 gap-4 items-center min-h-[70vh] relative z-10">
        {/* Left: Text */}
        <motion.div
        ...
        >
          ...
          <div className="space-y-6">
            ...
            <p className="text-xl text-gray-600 max-w-2xl leading-relaxed">
              <span className="text-maroon-600 font-semibold">AggieX</span> is A&M's premier non-profit accelerator. With the <span className="text-maroon-600 font-semibold">#1 engineering research budget</span>, <span className="text-maroon-600 font-semibold">largest undergrad population</span>, and <span className="text-maroon-600 font-semibold">massive alumni network</span>, AggieX is making Texas A&M into a startup engine.
            </p>
          </div>

          <div className="mobile-hero-buttons flex flex-col sm:flex-row gap-4">
            <button 
              onClick={() => handleSmoothNavigation('/vision')}
              className="mobile-hero-btn primary inline-flex items-center justify-center bg-maroon-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-maroon-700 transition-colors duration-200 text-lg shadow-sm hover:shadow-md"
            >
              Learn About Vision
            </button>
            <Link 
              to="/apply"
              className="mobile-hero-btn secondary inline-flex items-center justify-center border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-lg font-semibold hover:border-maroon-600 hover:text-maroon-600 bg-white transition-colors duration-200 text-lg"
            >
              Apply
            </Link>
          </div>
        ...
        >
          <div className="relative w-full max-w-lg md:h-[480px] rounded-2xl overflow-hidden shadow-xl border border-gray-200">
            ...
            <div className="absolute bottom-6 left-6 right-6">
              <div className="bg-white/95 backdrop-blur-sm rounded-xl p-2 text-center shadow-lg border border-gray-100">
