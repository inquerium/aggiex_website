              ...
              <div className="py-6 space-y-4">
                {mainLinks.map(link => (
                  <button
                    ...
                    className="block w-full text-left px-4 py-3 text-base font-helvetica font-semibold transition-colors text-gray-800 hover:text-maroon-700 hover:bg-maroon-50"
                  >
                    {link.name}
                  </button>
                ))}
                ...
                <div className="px-4 pt-4">
                  <Link 
                    to="/apply"
                    onClick={closeMenu}
                    className="block w-full text-center bg-maroon-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-maroon-700 transition-colors duration-200 shadow-sm"
                  >
                    Apply
                  </Link>
                </div>
